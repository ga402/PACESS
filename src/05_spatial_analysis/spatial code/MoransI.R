...
library(dplyr)
library(magrittr)
Rcpp::sourceCpp("~/Sharedfiles/cliu/MU20210901/finalcode/Rcpp_distance_matrix.cpp")
Rcpp::sourceCpp("~/Sharedfiles/cliu/MU20210901/finalcode/Rcpp_bikernel_function.cpp")
